...
public class MainBall extends Ball{
    ...
    public MainBall(double xPosition, double yPosition, double xVelocity, double yVelocity, double rotation, double rotateSpeed, double size, double density, Color color, double dragMultiplier, double dragSubtracter){
    ...
    public void keyUpdate(boolean up, boolean left, boolean right, boolean down){
        if(up){
            super.setYVelocity(super.getYVelocity() - acceleration);
        }
        if (left){
            super.setXVelocity(super.getXVelocity() - acceleration);
        }
        if (right){
            super.setXVelocity(super.getXVelocity() + acceleration);
        }
